...
ERoom은 **Anthropic Claude Sonnet 4**와 **Meshy 3D AI**를 활용하여 방탈출 게임을 자동으로 생성하는 혁신적인 시스템입니다. 복잡한 게임 개발 과정을 AI가 대신하여, 누구나 쉽게 창의적인 방탈출 게임을 만들 수 있습니다.

### ✨ 핵심 기능

| 기능                   | 설명                                |
|----------------------|-----------------------------------|
| **🤖 AI 시나리오 생성**    | Claude Sonnet 4가 테마와 난이도에 맞는 독창적인 퍼즐과 스토리 생성 |
